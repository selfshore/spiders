...
def login(username,password):
    ...
    captcha_r = requests.get('https://www.zhihu.com/api/v3/oauth/captcha?lang=en', headers=headers, cookies=cookie,verify=False)
    ...
    r_r = requests.post('https://www.zhihu.com/zbst/events/r', data= r_param, headers=headers, cookies=cookie, verify=False)
    print(r_r.text)
    ...
    r = requests.get('https://www.zhihu.com/api/v3/oauth/captcha?lang=cn', headers=headers, cookies=cookie, verify=False)
    ...
    r = requests.post('https://www.zhihu.com/api/v3/oauth/sign_in', data=formdata, headers=headers, cookies=cookie,verify=False)
