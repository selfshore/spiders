...
def airplane(depart, arrival, departureTime, ArrivalTime):
    city_dict = {"北京":"PEK","上海":"SHA","重庆":"CKG","昆明":"KMG","成都":"CTU","西安":"XIY","深圳":"SZX","厦门":"XMN",
                 "杭州":"HGH","青岛":"TAO","哈尔滨":"HRB","郑州":"CGO","广州":"CAN","海口":"HAK","贵阳":"KWE","长沙":"CSX",
                 ...
                 "朝阳":"CHG","长白山":"NBS","池州":"JUH","昌都":"BPX","承德":"CDE","长海":"CNI","沧源":"CWJ","大连":"DLC",
                 ...
                 "喀纳斯":"KJI","康定":"KGT","凯里":"KJH","兰州":"LHW","丽江":"LJG","拉萨":"LXA","柳州":"LZH","洛阳":"LYA",
                 "连云港":"LYG","临沂":"LYI","泸州":"LZO","临沧":"LNJ","黎平":"HZH","荔波":"LLB","梁平":"LIA","临汾":"LFQ",
                 "林芝":"LZY","吕梁":"LLV","六盘水":"LPF","绿岛":"GNI","兰屿":"KYD","林西":"LXI","澜沧":"JMJ","连城":"LCX",
                 "牡丹江":"MDG","绵阳":"MIG","满洲里":"NZH","芒市":"LUM","梅县":"MXZ","漠河":"OHE","马祖":"MFK","马公":"MZG",
                 "南宁":"NNG","宁波":"NGB","南昌":"KHN","南阳":"NNY","南通":"NTG","南充":"NAO","宁蒗":"NLH","攀枝花":"PZI",
                 "普洱":"SYM","屏东":"PIF","齐齐哈尔":"NDG","秦皇岛":"BPE","衢州":"JUZ","庆阳":"IQN","且末":"IQM","黔江":"JIQ",
                 "琼海":"BAR","七美":"CMJ","泉州":"JJN","日喀则":"RKZ","日照":"RIZ","沈阳":"SHE","三亚":"SYX","石家庄":"SJW",
                 "思茅(普洱)":"SYM","松原":"YSQ","十堰":"WDS","神农架":"HPG","石河子":"SHF","上饶":"SQD","三明":"SQJ",
                 "三沙":"XYI","邵阳":"WGN","莎车":"QSZ","太原":"TYN","通辽":"TGO","铜仁":"TEN","塔城":"TCG","通化":"TNH",
                 "唐山":"TVS","吐鲁番":"TLQ","腾冲":"TCZ","天水":"THQ","台北":"TPE","台南":"TNN","台东":"TTT","台中":"RMQ",
                 ...
                 "玉树":"YUS","营口":"YKH","宜春":"YIC","永州":"LLF","珠海":"ZUH","张家界":"DYG","湛江":"ZHA","舟山":"HSN",
    ...
    r = session.get('https://flight.qunar.com/touch/api/domestic/wbdflightlist', headers=headers,params=data,verify=False)
