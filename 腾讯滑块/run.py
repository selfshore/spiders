...
def tx_cap():
    ...
    r = requests.get('https://www.sf-express.com/sf-service-owf-web/service/captcha/getJsUrl?lang=sc&region=cn&translate=', headers=headers)
    ...
    vig_url = 'https://captcha.guard.qcloud.com/cap_union_new_show' + url + '&ua=' + ua + '&uid=&cap_cd=&lang=2052&random=0.2927051202751614' + '&sess=' \
             + result['sess'] + '&theme=&sid=' + result['sid'] + '&showtype=popup&fb=1&forcestyle=undefined&subsid=2&color=000000&uid=&cap_cd=&lang=2052&' \
    ...
    all_bg_url = 'https://captcha.guard.qcloud.com/cap_union_new_getcapbysig' + url + '&ua=' + ua + '&uid=&cap_cd=&lang=2052&random=0.2927051202751614' + '&sess=' \
             + result['sess'] + '&theme=&sid=' + result['sid'] + '&showtype=popup&fb=1&forcestyle=undefined&subsid=3&color=000000&uid=&cap_cd=&lang=' \
    ...
    init_mousemove = [[95, 307, 1076], [8, -8, 4], [9, -8, 10], [10, -6, 3], [9, -7, 8], [7, -6, 8], [6, -4, 8], [5, -3, 8], [2, -1, 8], [1, -2, 9], [2, -1, 6], [1, -1, 9], [0, -1, 110], [-1, 0, 63], [0, 1, 10], [-1, 0, 6], [0, 1, 9], [-2, 1, 4], [-1, 2, 8], [-2, 1, 8], [0, 1, 9], [-1, 1, 7], [-2, 1, 8], [-1, 2, 9], [-2, 1, 5], [-1, 2, 8], [-3, 1, 8], [-4, 2, 8], [-3, 1, 8], [-4, 2, 8], [-6, 1, 8], [-4, 1, 6], [-6, 1, 8], [-6, 1, 8], [-5, 2, 8], [-6, 1, 9], [-6, 2, 9], [-5, 2, 8], [-6, 1, 5], [-6, 1, 8], [-4, 0, 11], [-3, 0, 5], [-2, 0, 12], [-2, 0, 5], [-1, 0, 6], [-2, 0, 7], [-1, 0, 8], [-1, 0, 8], [-2, 0, 8], [-1, 0, 9], [-1, 0, 6], [-1, -1, 9], [-1, 0, 6], [-1, 0, 10], [-1, 0, 6], [-2, -1, 16], [-1, -1, 14], [-2, 0, 8], [-1, 0, 8], [-1, 0, 8], [-2, 0, 9], [-1, 0, 7], [-1, 0, 7], [-1, 0, 7], [-1, 0, 17], [-2, 0, 15], [0, -1, 22], [0, -1, 48], [0, -1, 27], [0, -1, 11], [0, -1, 23], [0, -1, 28], [1, -1, 22], [1, 0, 12], [0, -1, 13], [0, -1, 10], [1, 0, 6], [0, -1, 27], [1, 0, 36], [0, -1, 9], [1, 0, 356]]
    ...
    r = requests.post('https://captcha.guard.qcloud.com/cap_union_new_verify?random=1593273420672', data=dt, headers=headers)
    print(r.text)
